...
class LaporanController extends Controller
{
    ...
    {
        $set_tanggapan = Pengaduans::get();

        $pdf = PDF::loadView('pengaduan_pdf', compact('set_tanggapan'))->setPaper('a4', 'landscape');
        $pdf->save(storage_path() . '_filename.pdf');
        return $pdf->stream();
    }
    public function cetakPegawai()
    {
        $set_tanggapan = Pengaduans::all();

        return view('pengaduan_pdf', compact('set_tanggapan'));
    }
    // public function cetak_pdf()
    // {
